...
2. Convert categorical variables into numerical values using encoding.

3. Split the dataset into input features (X) and target output (y).
...
7. Evaluate the model using confusion matrix, accuracy score, and classification report.
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/6e6e79df-43a5-4a6b-95a6-b86ffb4f6cac" />
